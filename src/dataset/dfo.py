...
class DFoDataModule(DeepFakeDataModule):
    def __init__(
        self,
        *args,
        **kargs
    ...
    def prepare_data(self):
        DFo.prepare_data(self.data_dir, self.vid_ext)
...
if __name__ == "__main__":
    ...
    # save_folder = f"./misc/extern/dump_dataset/dfo/test/"
    # # entity dump
